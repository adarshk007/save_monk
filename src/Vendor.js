  	...
  	if (api_s.status >= 200 && api_s.status < 400) 
		...
		if(true){
		    ...
		    newNode.innerHTML = "<div class='col col-1' data-label='icon'><img src='"+(beta.Logo)+"' class='image_op'/></div>"+
				  ...
				  "<div class='col col-7' data-label='link'><button id='accept' type='button' class='btn btn-success'><span class='glyphicon glyphicon-ok'></span></button>&nbsp;&nbsp;<button id='reject' type='button' class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span></button></div>"                          
	//                           "<p>"+(beta.Item)+"</p>"+
